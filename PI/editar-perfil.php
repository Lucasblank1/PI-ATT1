...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        if (isset($_FILES['foto']) && $_FILES['foto']['error'] === UPLOAD_ERR_OK) {
            ...
            $nome_arquivo = 'perfil_' . $_SESSION['usuario_id'] . '.' . $extensao;
            ...
            $padrao = $diretorio . 'perfil_' . $_SESSION['usuario_id'] . '.*';
            ...
            $stmt = $conn->prepare("UPDATE usuarios SET foto_perfil = ?, foto = NULL WHERE id = ?");
...
<head>
    ...
    <title>Editar Perfil - GameLearn História</title>
