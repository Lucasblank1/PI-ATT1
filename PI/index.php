            ...
            <div class="flex justify-between items-center">
                ...
                <nav>
                    <ul class="flex space-x-6">
                        <li><a href="#" class="hover:text-amber-200 font-semibold">Início</a></li>
                        <li><a href="#modules" class="hover:text-amber-200 font-semibold">Matérias</a></li>
                        <li><a href="jogos.php" class="hover:text-amber-200 font-semibold">Jogos</a></li>
                        <li><a href="#about" class="hover:text-amber-200 font-semibold">Sobre</a></li>
    ...
    <section class="py-16">
        <div class="container mx-auto px-4 text-center">
            <div class="max-w-3xl mx-auto">
                ...
                <p class="text-xl text-gray-700 mb-8">Descubra o passado de forma divertida com nossos jogos de história para alunos das séries iniciais.</p>
            ...
            <div class="mt-12 flex justify-center">
                <img src="assets/images/history-hero.png" alt="Crianças aprendendo história" class="w-64 h-64 object-contain">
            </div>
        </div>
    </section>
